...
context "Drop Filters" do
  ...
  it "should find section by path" do
  ...
  it "should not find inexistent section by path even if children exist" do
    assert_nil section('earth/europe/romania')
  end

  it "should find latest articles by section" do
  ...
  it "should find latest comments by section" do
    section = liquify(sections(:home)).first
  ...
  it "should find latest articles by site" do
  ...
  it "should find latest comments by site" do
  ...
  it "should find child sections" do
  ...
  it "should find descendant sections" do
  ...
  it "should find articles by month" do
